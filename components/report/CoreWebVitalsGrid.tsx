  ...
  const cards: MetricCardConfig[] = [
    {
      ...
      goodMax: 2500,
      warnMax: 4000,
      description: "Measures when the largest visible content block finishes rendering.",
    ...
    },
    {
      ...
      goodMax: 200,
      warnMax: 600,
      description: "Total time the main thread was blocked between FCP and Time to Interactive.",
    ...
    },
    {
      ...
      goodMax: 0.1,
      warnMax: 0.25,
      description: "Measures unexpected layout shifts while the page loads.",
    ...
    },
    {
      ...
      goodMax: 1800,
      warnMax: 3000,
      description: "Time until the browser paints the first text or image.",
            ...
            >
              <div className="space-y-3.5">
                ...
                <div className="flex items-start justify-between gap-3">
                  <div className="flex items-center gap-2.5 min-w-0">
                    ...
                    <div className="min-w-0">
                      <div className="flex items-center gap-1.5 flex-wrap">
                        ...
                        {card.isCoreVital && (
                          <span className="px-2 py-0.5 rounded-full text-[10px] font-mono font-semibold text-brand-600 dark:text-brand-300 bg-brand-50 dark:bg-brand-500/10 border border-brand-200 dark:border-brand-500/30 whitespace-nowrap">
                            Core Vital
                          </span>
                        )}
                      </div>
                  ...
                  <span
                    className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold shrink-0 whitespace-nowrap ${theme.pill}`}
                  >
