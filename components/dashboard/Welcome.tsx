...
const Welcome = ({ user }: { user: KindeUser }) => {
  return (
    <div className="space-y-3 pb-1 max-w-3xl">
      ...
      <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-mono text-text-secondary bg-surface-0/60 dark:bg-white/4 border border-border/60 backdrop-blur-md shadow-2xs">
