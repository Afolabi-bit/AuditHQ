...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        "bg-surface-1/70 dark:bg-white/[0.04] text-muted-foreground inline-flex h-10 w-fit items-center justify-center rounded-xl p-1 border border-border/60 dark:border-white/[0.07]",
        className
      )}
      {...props}
    />
